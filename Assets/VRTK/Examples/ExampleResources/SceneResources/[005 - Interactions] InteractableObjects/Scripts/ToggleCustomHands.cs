    ...
    public class ToggleCustomHands : MonoBehaviour
    {
        ...
        protected virtual void ToggleSDKVisibility()
        {
            ...
            if (sdkType != null)
            {
                ...
                {
                    case "SteamVR":
                        ToggleSteamVRController();
                        break;
                }
            }
        }

        protected virtual void ToggleSteamVRController()
        {
            GameObject actualLeft = VRTK_DeviceFinder.GetControllerLeftHand(true);
            GameObject actualRight = VRTK_DeviceFinder.GetControllerRightHand(true);
            ToggleSteamVRRenderer(actualLeft);
            ToggleSteamVRRenderer(actualRight);
        }
